...
namespace Tekla.Logging.LoggerImpl
{
    using System;
    ...
    public class TraceLogManager
    {
        ...
        /// <remarks>
        /// <para>
        /// If the named logger exists (in the default hierarchy) then it returns a reference to the logger, otherwise it returns <c>null</c>. 
        /// </para>
        /// </remarks>
        /// <param name="name">
        ...
        /// <remarks>
        /// <para>
        /// If the named logger exists (in the specified domain) then it returns a reference to the logger, otherwise it returns <c>null</c>. 
        /// </para>
        /// </remarks>
        /// <param name="domain">
        ...
        /// <remarks>
        /// <para>
        /// If the named logger exists (in the specified assembly's domain) then it returns a reference to the logger, otherwise it returns <c>null</c>. 
        /// </para>
        /// </remarks>
        /// <param name="assembly">
        ...
        /// <remarks>
        /// <para>
        /// Retrieve a logger named as the <paramref name="name"/> parameter. If the named logger already exists, then the existing instance will be returned. Otherwise, a new instance is created. 
        /// </para>
        /// <para>
        ...
        /// </remarks>
        /// <param name="type">
        /// The full name of <paramref name="type"/> will be used as the name of the logger to retrieve. 
        /// </param>
        /// <returns>
        /// The logger with the name specified.
        /// </returns>
        ...
        {
            return (ITraceLog)WrapperMap.GetWrapper(logger);
        }
        ...
        /// </param>
        /// <returns>
        /// Returns the wrapper objects for the loggers specified.
        /// </returns>
